...
var PaymentRequestComponent = /** @class */ (function () {
    function PaymentRequestComponent(cd, payment, router, Auth) {
        this.cd = cd;
    ...
    PaymentRequestComponent.prototype.onChange = function (_a) {
        var error = _a.error;
        if (error) {
    ...
    PaymentRequestComponent.prototype.onSubmit = function (form) {
    ...
    ], PaymentRequestComponent.prototype, "cardInfo", void 0);
    PaymentRequestComponent = __decorate([
        ...
        __metadata("design:paramtypes", [ChangeDetectorRef, PaymentService, Router, AuthService])
    ], PaymentRequestComponent);
    return PaymentRequestComponent;
}());
export { PaymentRequestComponent };
//# sourceMappingURL=payment-request.component.js.map